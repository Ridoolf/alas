...
export const serviciosGenerales = {
  ...
  instalaciones: [
    'Recepción general.',
    'Dirección Médica.',
    '3 Salas de esperas (una en P.B. y dos en 1er piso)',
    '20 consultorios muy luminosos, completamente equipados, adaptados para el uso profesional de cada especialidad.',
    'Sala con 4 boxes equipados con sillones para tratamientos ambulatorios, LCD y un carro de Paro.',
    '6 Toilettes.',
    '1 vestuario para el personal.',
    '4 Depósitos, (3) al servicio de los profesionales.',
    '1 Office adaptado para sala de Esterilización.',
    '1 Office adaptado para enfermería.',
    'Doble circulación de escaleras y ascensor.',
    'Climatización central e internet wifi de alta velocidad.',
